...
The latest release version of the specification is [version **1.2**](docs/CEX-spec-1.2.md).

The current draft version of the specification is [version **2.0**](docs/CEX-spec-2.0.md).
