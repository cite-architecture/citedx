...
The latest release version of the specification is [version **1.0**](docs/CEX-spec-1.0.md).

The current draft version of the specification is [version **1.1**](docs/CEX-spec-1.1.md).
